        ...
        <div class="lijevo2">
            <div class="ocjene2">
                <div class="likes">
                        ...
                        <div class="likes1">
                    <asp:ImageButton ID="btn_Like" CssClass="dodajkomentdugme" runat="server" Text="Up" Width="32px" OnClick="btn_Like_Click"  Height="32px" ImageUrl="~/Content/Buttons/Up.png" /> 
                    <asp:Label ID="lbl_Likes"  runat="server"></asp:Label> 
                    <br />
                     
                   
                                    
                    <asp:ImageButton ID="btn_Unlike" CssClass="dodajkomentdugme" runat="server" Text="Down" OnClick="btn_Unlike_Click" Width="32px" Height="32px" ImageUrl="~/Content/Buttons/Down.png" /> 
                    ...
                    <div class="stars">
                        <div class="zvezdice">       
                    <asp:Button ID="btn_RateThis_01" CssClass="dodajkomentdugme" runat="server" OnClick="btn_RateThis_01_Click" Text="1" Width="32px" Height="32px" />
                    <asp:Button ID="btn_RateThis_02" CssClass="dodajkomentdugme" runat="server" OnClick="btn_RateThis_02_Click" Text="2" Width="32px" Height="32px" />
                    <asp:Button ID="btn_RateThis_03" CssClass="dodajkomentdugme" runat="server" OnClick="btn_RateThis_03_Click" Text="3" Width="32px" Height="32px" />
                    <asp:Button ID="btn_RateThis_04" CssClass="dodajkomentdugme" runat="server" OnClick="btn_RateThis_04_Click" Text="4" Width="32px" Height="32px" />
                    <asp:Button ID="btn_RateThis_05" CssClass="dodajkomentdugme" runat="server" OnClick="btn_RateThis_05_Click" Text="5" Width="32px" Height="32px" />
                        </div>
                        <p><asp:Label ID="lbl_RateThis" runat="server">Rate </asp:Label></p>
                        <br />
                    <div class="pitanjeautor" >
                        <asp:ImageButton ID="img_Korisnik" runat="server" />
            ...
            <ItemTemplate>
                <div >
                    <div class="odgovorslika">
                        <asp:ImageButton ID="img_User" runat="server" Height="70px" Width="70px" />
