...
<div id="glavna">
    <div class="omotac2">
        ...
        <asp:TextBox ID="txt_Sadrzaj" runat="server" TextMode="MultiLine" CssClass="mceEditor" EnableViewState="True" Width="100%" AutoPostBack="True"></asp:TextBox><br />
        <asp:Label ID="lbl_Sazetak" runat="server" Text="Sažetak"></asp:Label><br /><br />
        <asp:TextBox ID="txt_Sazetak" runat="server" TextMode="MultiLine" CssClass="mceEditor" EnableViewState="True" Width="100%" AutoPostBack="True"></asp:TextBox><br /><br />
