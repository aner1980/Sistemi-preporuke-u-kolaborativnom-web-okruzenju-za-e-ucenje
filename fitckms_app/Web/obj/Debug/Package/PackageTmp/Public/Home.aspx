                    ...
                    <ul>
                        <asp:DataList ID="rpt_TagoviQA" runat="server" OnItemDataBound="rpt_TagoviQA_ItemDataBound">
                            ...
                            <ItemTemplate>
                                <li>
                                    <div class="tagobruc">
                                        <asp:LinkButton ID="lb_TagNaziv" runat="server" PostBackUrl='<%# "~/Public/QA_Pitanja.aspx?TagID=" + Eval("id") %>'>  <%#Eval("Naziv") %> </asp:LinkButton></div>
                                    <div class="brojtagovani">
                    ...
                    <ItemTemplate>
                        ...
                        <div class="clanak">
                            ...
                            <div class="clanakomotac">
                                ...
                                <div class="dnaslov">
                                    <asp:LinkButton ID="txt_Naslov" runat="server" PostBackUrl='<%# "~/Public/Clanak.aspx?PostID=" + Eval("id") %>'> Server.HtmlEncode(<%#Eval("Naslov") %>)</asp:LinkButton>
