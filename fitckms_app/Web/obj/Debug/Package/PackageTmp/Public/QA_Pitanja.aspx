<%@ Page Title="" Language="C#" MasterPageFile="~/Public/QA.Master" AutoEventWireup="true" EnableEventValidation="true" CodeBehind="QA_Pitanja.aspx.cs" Inherits="Web.Public.QA_Pitanja" %>
        ...
        <div class="lijevo">
            ...
            <div class="searchinfo2">
                ...
                <ul>
                    ...
                    <li>
                        <asp:Button ID="btn_Neodgovorena" runat="server" Text="Neodgovorena" OnClick="btn_Neodgovorena_Click" CssClass="nav2dugmadi" /></li>
                    <li>
                        <asp:Button ID="btn_Korisnik" runat="server" Text="Korisnici" OnClick="btn_Korisnik_Click" CssClass="nav2dugmadi" /></li>
<%--                    <li class="zadnja">
                        <asp:Button ID="btn_OvogMjeseca" runat="server" Text="Ovog mjeseca" OnClick="btn_Korisnik_Click" CssClass="nav2dugmadi" /></li>--%>
                </ul>
...
<%--        <asp:Button ID="btn_Posljednje" runat="server" Text="Posljednje" OnClick="btn_Posljednje_Click" />
        <asp:Button ID="btn_Istaknuti" runat="server" Text="Istaknuto" OnClick="btn_Istaknuti_Click" />
        <asp:Button ID="btn_Neodgovorena" runat="server" Text="Neodgovorena" OnClick="btn_Neodgovorena_Click" />
         <asp:Button ID="btn_Korisnik" runat="server" Text="Korisnik" OnClick="btn_Korisnik_Click"  />
               <br />
        <hr />--%>
                            ...
                            <div class="pitanjeobruc">
                                ...
                                <div class="pitanjainfo">
                                    ...
                                    <div class="rep">
                                        ...
                                        <asp:ImageButton ID="img_User" runat="server" Height="16px" Width="16px" CssClass="pitanjadugmadi" />
