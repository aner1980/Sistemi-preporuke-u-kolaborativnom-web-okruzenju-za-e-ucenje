    ...
    public partial class Clanak : System.Web.UI.Page
    {
            ...
            using (TriglavBL temp = new TriglavBL())
            {
                if (Request.QueryString != null)
                {
                    if (Request.QueryString["PostID"] != null)
                    {
                        ...
                        //Guid Dr = IndirectReferenceMap.AddDirectReference(postId);
                        //Guid Ir = IndirectReferenceMap.GetIndirectReference(postId);
                        //int drref = IndirectReferenceMap.GetDirectReference(Ir);
                        //Response.Write(postId + Dr.ToString() + Ir.ToString() + drref.ToString());
                        //post = IndirectReferenceMap.GetClanak(Ir); 
                    }
                    else
                    {
        ...
        private void LoadClanak(int postId)
        {
            using (TriglavBL temp = new TriglavBL())
            {
                ...
                dl_WikiPoveznice.DataSource = Data.Lucene.Pretraga.getClanciPretrage(post.Tagovi, post.id).Take(5);                
                dl_WikiPoveznice.DataBind();

                dl_QAPoveznice.DataSource = Data.Lucene.Pretraga.getPitanjaPretrage(post.Tagovi, post.id).Take(5);
        ...
        private void EnableAllRateButtons()
        {
            ...
            lbl_RateThis.Text = "Ocijeni članak";
        }
                ...
                case 1:
                    {
                        ...
                        btn_RateThis_04.Enabled = true;
                        btn_RateThis_05.Enabled = true;
                        lbl_RateThis.Text = "Ocijenili ste članak: 1";
                    } break;
                case 2:
                    {
                        btn_RateThis_01.Enabled = true;
                        ...
                        btn_RateThis_04.Enabled = true;
                        btn_RateThis_05.Enabled = true;
                        lbl_RateThis.Text = "Ocijenili ste članak: 2";
                    } break;
                case 3:
                    {
                        btn_RateThis_01.Enabled = true;
                        ...
                        btn_RateThis_04.Enabled = true;
                        btn_RateThis_05.Enabled = true;
                        lbl_RateThis.Text = "Ocijenili ste članak: 3";
                    } break;
                case 4:
                    {
                        btn_RateThis_01.Enabled = true;
                        ...
                        btn_RateThis_04.Enabled = false;
                        btn_RateThis_05.Enabled = true;
                        lbl_RateThis.Text = "Ocijenili ste članak: 4";
                    } break;
                case 5:
                    {
                        btn_RateThis_01.Enabled = true;
                        ...
                        btn_RateThis_04.Enabled = true;
                        btn_RateThis_05.Enabled = false;
                        lbl_RateThis.Text = "Ocijenili ste članak: 5";
                    } break;
